...
| xaml.ps1 | XAML is well-formed; every control the script looks up exists; the Languages tab list on real WPF controls (Windows only) |
...
| profiles.ps1 | JSON profiles, order manifest, support status, archive, free-space check, the Languages tab list (Profiles\Languages.json) |
