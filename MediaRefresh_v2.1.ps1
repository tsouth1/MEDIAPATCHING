...
<#
.SYNOPSIS
    WimForge v2.1 - GUI offline servicing for Configuration Manager OSD WIMs.
.DESCRIPTION
...
function Invoke-MediaRefresh {
    ...
    Write-Log "Starting WimForge v2.1 for $name"
...
#region GUI
[xml]$xaml = @'
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Title="WimForge v2.1" Height="780" Width="1040" WindowStartupLocation="CenterScreen" Background="#F4F6F8">
