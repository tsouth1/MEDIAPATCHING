...
- **Mock test kit:** 7 suites, 317 checks, all passing on Windows PowerShell 5.1 and PowerShell 7.6 (2026-09-26).
...
| [10](#s10) | Operator UX: INSTRUCTIONS.md + Instructions tab, saved settings, utility menu, Languages tab from Languages.json | Claude (+ Terry for the inventory script) | 10e built 2026-09-26 (confirm in the real GUI); 10a-10d not started |
...
**10c. "Save settings" button: remember the GUI choices per OS (Terry, 2026-09-27; replaces the earlier auto-save idea)**
